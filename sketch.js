...
function draw(){
    ...
    if(gameState===START){
        ...
        text("Thanks to Google and some websites for images/sounds",displayWidth/2-250,displayHeight/2+250);
        text("RECOMMENDED ON PC DEVICES",displayWidth/2-165,displayHeight/2+280);
    ...
    if(gameState===QUIZ){
        ...
        if(ques===1){
            ...
            strokeWeight(1);
            fill('black');
            text("Question 1: How many milk should you drink?",displayWidth/2-710,displayHeight/2-200);
